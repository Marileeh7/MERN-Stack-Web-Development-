        ...
        <tbody>
          {players.map(player => (
            <tr key={player._id}>
              ...
              <td>
                <button
                  style={{ backgroundColor: player.statusGame3 === 'Playing' ? 'green' : '' }}
                ...
                <button
                  style={{ backgroundColor: player.statusGame3 === 'Not Playing' ? 'red' : '' }}
                ...
                <button
                  style={{ backgroundColor: player.statusGame3 === 'Undecided' ? 'yellow' : '' }}
